...
```text
training/outputs/eval/archive/260511_old_training_records_keep_baseline_legacy_b_lr8e5_valloss/comparisons/260511_travelmind_valloss_lr6e5_vs_lr8e5_final208_legacy_b_baseline_full_report/travelmind_valloss_lr6e5_vs_lr8e5_final208_legacy_b_baseline_full_report.md
```
...
- 数据：`training/data/travelmind/eval/records.jsonl`，200 条
```
...
- 数据：`training/data/travelmind/eval_hard/records.jsonl`，300 条
```
