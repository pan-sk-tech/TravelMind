...
.venv-training-py311/bin/python3 training/scripts/eval/eval_slice_report.py \
  --records training/data/travelmind/eval/records.jsonl \
  ...
  --model-report legacy_b=training/outputs/eval/by_model/sft_qwen25_7b_travelmind_1000_cp2_legacy_b/260511_high_end_context_standard_w10/rule_eval_report.json \
  --model-report lr8e5=training/outputs/eval/by_model/sft_qwen25_7b_travelmind_260509_main_clean_cp2_legacy_b_valloss_lr8e5/260511_high_end_context_standard_w10/rule_eval_report.json \
...
```bash
.venv-training-py311/bin/python3 training/scripts/eval/eval_slice_report.py \
  --records training/data/travelmind/eval_hard/records.jsonl \
  --model-report base=training/outputs/eval/by_model/base_qwen25_7b/260511_high_end_context_hard_w10/rule_eval_report.json \
  --model-report legacy_b=training/outputs/eval/by_model/sft_qwen25_7b_travelmind_1000_cp2_legacy_b/260511_high_end_context_hard_w10/rule_eval_report.json \
  --model-report lr8e5=training/outputs/eval/by_model/sft_qwen25_7b_travelmind_260509_main_clean_cp2_legacy_b_valloss_lr8e5/260511_high_end_context_hard_w10/rule_eval_report.json \
...
```bash
.venv-training-py311/bin/python3 training/scripts/travelmind/eval/audit_relaxed_grounding.py \
...
```bash
.venv-training-py311/bin/python3 training/scripts/travelmind/eval/generate_full_report.py \
  --current-label candidate \
  --primary-label legacy_b \
  --baseline-label baseline \
  --title "Candidate vs legacy_b / Baseline 全量评估报告" \
  --standard-records training/data/travelmind/eval/records.jsonl \
  --hard-records training/data/travelmind/eval_hard/records.jsonl \
  --report standard/candidate=training/outputs/eval/by_model/<candidate_family>/<candidate_standard_slug>/rule_eval_report.json \
  --report hard/candidate=training/outputs/eval/by_model/<candidate_family>/<candidate_hard_slug>/rule_eval_report.json \
  --report standard/legacy_b=training/outputs/eval/by_model/sft_qwen25_7b_travelmind_1000_cp2_legacy_b/260511_high_end_context_standard_w10/rule_eval_report.json \
  --report hard/legacy_b=training/outputs/eval/by_model/sft_qwen25_7b_travelmind_1000_cp2_legacy_b/260511_high_end_context_hard_w10/rule_eval_report.json \
