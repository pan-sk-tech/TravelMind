...
<p align="center">
  <img src="./images/旅行助手后训练实战/02-开篇Case前后对比图.png" alt="开篇 Case 前后对比图" width="90%"/>
</p>

图中预算数字用于表达前后对比关系，原始 case 的具体数值以本节表格为准。
...
<p align="center">
  <img src="./images/旅行助手后训练实战/01-后训练主线总览图.png" alt="后训练主线总览图" width="90%"/>
</p>
...
<p align="center">
  <img src="./images/旅行助手后训练实战/03-产品协议改造图.png" alt="产品协议改造图" width="90%"/>
</p>
...
<p align="center">
  <img src="./images/旅行助手后训练实战/04-评测集冻结图.png" alt="评测集冻结图" width="90%"/>
</p>
...
<p align="center">
  <img src="./images/旅行助手后训练实战/05-SFT数据生成与审计漏斗图.png" alt="SFT 数据生成与审计漏斗图" width="90%"/>
</p>
...
<p align="center">
  <img src="./images/旅行助手后训练实战/06-LoRA多阶段训练时间线图.png" alt="LoRA 多阶段训练时间线图" width="90%"/>
</p>
...
<p align="center">
  <img src="./images/旅行助手后训练实战/07-Best-of-N-Replay与Rerank图.png" alt="Best-of-N Replay 与 Rerank 图" width="90%"/>
</p>
