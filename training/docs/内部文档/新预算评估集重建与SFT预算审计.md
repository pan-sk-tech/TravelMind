...
- 离线审计已有 SFT records 的预算是否贴合新预算表：
  - `training/outputs/eval/audits/260507_sft_budget_fit_audit/sft_budget_fit_audit.md`
...
```text
training/outputs/eval/audits/260507_sft_budget_fit_audit/sft_budget_fit_audit.md
training/outputs/eval/audits/260507_sft_budget_fit_audit/summary.json
training/outputs/eval/audits/260507_sft_budget_fit_audit/audit_rows.jsonl
```
...
- 新评估集可以作为下一轮 base/SFT/legacy_a/legacy_b 横评输入。
