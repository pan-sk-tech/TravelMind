...
CONFIG=/work/liweihan/wyf/helloagents-trip-planner/training/configs/qwen25_7b/dpo_260520_closing_budget_clean_from_ckpt138_r32_2epoch_ctx24576_z3nooffload_label_logits_4gpu0123.yaml

cd /work/liweihan/wyf/LLaMA-Factory

echo "[run] $(date '+%F %T') starting closing budget-clean DPO from ckpt138 on GPUs ${CUDA_VISIBLE_DEVICES}"
