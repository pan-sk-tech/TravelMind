...
TRAVELMIND_CONTEXT_PRINT_LIMIT = int(os.getenv("TRAVELMIND_CONTEXT_PRINT_LIMIT", "8"))


def print_summary(travelmind_context: Dict[str, Any]) -> None:
    """打印结构化工具快照摘要。"""
...
def print_visualization(travelmind_context: Dict[str, Any], limit: int = TRAVELMIND_CONTEXT_PRINT_LIMIT) -> None:
    """在命令行打印步骤1工具快照明细，便于直接审查。"""
    snapshot = travelmind_context.get("tool_snapshot", {})
    print("=" * 60)
    print("TravelMindContext 明细预览")
    print("=" * 60)
